...
Below is a brief description of the functions implemented in the project:
    ...
    parse_command(): Handles error checking and discovers command start and end in the token array.
    ...
    check_wildcard(): Checks for wildcard expressions in a command.
    handle_wildcard(): Handles wildcard expressions in a command.
